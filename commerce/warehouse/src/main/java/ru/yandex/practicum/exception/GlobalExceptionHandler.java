...
public class GlobalExceptionHandler {
    ...
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public Map<String, Object> handleSpecifiedProductAlreadyInWarehouseException(SpecifiedProductAlreadyInWarehouseException e) {
        Map<String, Object> response = new HashMap<>();
        response.put("status", e.getHttpStatus());
        response.put("reason", "The product is already in Warehouse");
        response.put("message", e.getMessage());
