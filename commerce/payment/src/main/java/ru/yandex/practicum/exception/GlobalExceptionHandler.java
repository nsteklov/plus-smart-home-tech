...
public class GlobalExceptionHandler {
    ...
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public Map<String, Object> handleNotEnoughInfoInOrderToCalculateException(NotEnoughInfoInOrderToCalculateException e) {
        Map<String, Object> response = new HashMap<>();
        response.put("status", e.getHttpStatus());
        response.put("reason", "Not enough information to calculate");
        response.put("message", e.getMessage());
    ...
    public Map<String, Object> handleNoOrderFoundException(NoOrderFoundException e) {
        Map<String, Object> response = new HashMap<>();
        response.put("status", e.getHttpStatus());
